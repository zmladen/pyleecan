...
def _comp_line_dict(self):
    ...
    line_dict["12-13"] = Segment(Z12, Z13, prop_dict={"ref": True})
    line_dict["13-14"] = Segment(Z13, Z14, prop_dict={"adj": True})
    line_dict["14-15"] = Arc1(Z14, Z15, abs(Z15))
    line_dict["15-16"] = Segment(Z15, Z16, prop_dict={"adj": True})
    line_dict["16-17"] = Segment(Z16, Z17, prop_dict={"ref": True})
